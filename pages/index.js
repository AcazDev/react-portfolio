...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      ...
      <main className=" bg-white px-10 dark:bg-bg_all md:px-20 lg:px-40 max-h-[44.6rem]  scrollbar scrollbar-thumb-blue-700 scrollbar-track-blue-300 overflow-y-scroll dark:scrollbar-thumb-blue-100 dark:scrollbar-track-gray-700 ">
        ...
        <section className="min-h-screen">
          ...
          <div className="text-start py-10 inline-flex">
            <div className="pr-8">
              ...
              Desenvolvedor que presta serviços para necessidades de conteúdo de programação, design e Ilustração. 
              Junte-se a mim abaixo e vamos inovar!
              </p>
