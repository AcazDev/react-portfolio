...
export default function Home() {
          ...
          <div className="text-start py-10 inline-flex">
            <div className="pr-8">
              ...
              <button id="contato" class="bg-gradient-to-b from-red-500 to-amber-500 rounded-full m-8
               text-white text-2xl font-bold px-8 py-2.5"
              >
                Contato
              </button>
  ...
  Save changes
            ...
            <div className="mx-auto bg-gradient-to-b from-gray-900 rounded-full w-80 h-80 relative md:h-96 md:w-96 hover:bg-amber-500">
